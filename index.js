...
function CemberinAlani(cemberYariCap, piSayisi){
	let cemberinAlani = piSayisi * (Math.pow (cemberYariCap, 2));
...
/*  (oto test yok) sayilar dizisi içinde kaç adet sayı olduğunu konsola yazdırın */
	...
	var ucebolunenlerintoplami = ucetambolunenler.reduce ((total,item) => {
		return total + item;
	})
	...
	let kucukSayilar = (sayi) => {
		return sayi < 500;
	}
	var besyuzdenkucuksayilar = sayilar.filter(kucukSayilar);
